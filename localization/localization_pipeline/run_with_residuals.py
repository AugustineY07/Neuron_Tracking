...
from localizer_with_residuals import LOCALIZER
...
bin_file = 'D:/Pipeline/Localization/day1 sample/standardized.bin'
dtype_input = 'float32'

fname_spike_train = 'D:/Pipeline/Localization/day1 qualified/day1_spike_for_localization.npy'
...
geom_path = 'D:/Pipeline/Localization/day1 qualified/geom.npy'
n_channels = np.load(geom_path).shape[0]

denoiser_weights = 'D:/Papers/3D Localization/spikes_localization_registration/pretrained_denoiser/denoise.pt'
...
#fname_templates = "D:/Pipeline/Localization/day1 nosample/day1_templates.npy"
...
fname_templates = "D:/Pipeline/Localization/day1 nosample/templates.npy"
np.save(fname_templates, localizer_obj.get_templates()) #localizer_obj.get_templates()
...
fname_out = 'D:/Pipeline/Localization/day1 nosample/residuals/residual.bin'
dtype_out = 'float32'
dtype_in = 'float32'
...
residual_file = 'D:/Pipeline/Localization/day1 nosample/residuals/residual.bin'
