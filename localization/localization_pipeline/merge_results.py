...
def get_merged_arrays(input_directory, output_directory, n_batches):
    ...
    for batch_id in tqdm(range(n_batches)):
        ...
        #fname_ids = os.path.join(input_directory, 'ids_{}.npy'.format(str(batch_id).zfill(6)))
        ...
        #merged_ids[cmp:cmp+len_batch[batch_id]] = np.load(fname_ids)
    ...
    #fname_merged_ids = os.path.join(output_directory, 'merged_ids.npy')
    ...
    #np.save(fname_merged_ids, merged_ids)
